...
bool W2D_Algorithm::addCol (Arrangement *r, Rectangle *p_src, int row_nr, int col_nr, TauLopSequence *seq) {
...
bool W2D_Algorithm::addRow (Arrangement *r, Rectangle *p_src, int row_nr, int col_nr, TauLopSequence *seq) {
...
bool W2D_Algorithm::addColConcurrent (Arrangement *r, Rectangle *p_src, int row_nr, int col_nr, TauLopConcurrent *conc) {
...
bool W2D_Algorithm::addRowConcurrent (Arrangement *r, Rectangle *p_src, int row_nr, int col_nr, TauLopConcurrent *conc) {
...
Cost * W2D_Algorithm::execute (Arrangement *r) {
...
*/
    ...
    // DBG:
    tc->show();
    cout << endl << " FE Time: " << tc->getTime() << endl << endl;
#endif
